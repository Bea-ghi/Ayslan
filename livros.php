        ...
        <nav class="navbar navbar-expand-lg navbar-dark py-lg-4" id="mainNav">
            <div class="container">
                ...
                <ul class="navbar-nav mx-auto">
                        <li class="nav-item px-lg-4"><a class="nav-link text-uppercase" href="pricipal.php">Pricipal</a></li>
...
?>
        ...
        <script>
            fetch('https://www.googleapis.com/books/v1/volumes?q=<?php $pesquisa ?>
            &key=AIzaSyBllud3lb3S4GXzcIkQHUv2DLmcoZGTPFg)')
